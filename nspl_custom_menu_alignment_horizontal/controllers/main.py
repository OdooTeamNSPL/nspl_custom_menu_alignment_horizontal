...
class MenuLayoutController(http.Controller):
    ...
    @http.route('/web/session/get_company_menu_layout_horizontal', type='json', auth='user')
    def get_company_menu_layout_horizontal(self):
        layout = request.env.user.company_id.menu_layout_horizontal or 'default'
